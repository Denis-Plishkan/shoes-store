...
async function getShoes() {
    try {
        ...
        shoesData.value = shoesData.value.filter((item) => item.price.newPrice > 3500);
    }
    catch (error) {
        console.log(error);
    }
...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.section, __VLS_intrinsicElements.section)({ ...{ class: ("maybe") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("maybe__container") }, });
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("receipts__prev discount__prev") }, });
    // @ts-ignore
    [BaseIcon,];
    // @ts-ignore
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("receipts__next discount__next") }, });
    // @ts-ignore
    [BaseIcon,];
    // @ts-ignore
    ...
    if (typeof __VLS_styleScopedClasses === 'object' && !Array.isArray(__VLS_styleScopedClasses)) {
        __VLS_styleScopedClasses['maybe'];
        __VLS_styleScopedClasses['maybe__container'];
        ...
        __VLS_styleScopedClasses['discount__prev'];
        __VLS_styleScopedClasses['receipts__next'];
        __VLS_styleScopedClasses['discount__next'];
