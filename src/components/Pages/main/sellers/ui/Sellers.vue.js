...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("receipts__arrows sellers__") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("sellers__prev") }, });
    // @ts-ignore
    [BaseIcon,];
    // @ts-ignore
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("sellers__next") }, });
    // @ts-ignore
    [BaseIcon,];
    // @ts-ignore
    ...
    if (typeof __VLS_styleScopedClasses === 'object' && !Array.isArray(__VLS_styleScopedClasses)) {
        ...
        __VLS_styleScopedClasses['sellers__'];
        __VLS_styleScopedClasses['sellers__prev'];
        __VLS_styleScopedClasses['sellers__next'];
